...
import { CreditsStatusBar } from "./core/kilocode/CreditsStatusBar" // credits status bar
...
export async function activate(context: vscode.ExtensionContext) {
	...
	// credits status bar initialization start
	...
	// credits status bar initialization end
