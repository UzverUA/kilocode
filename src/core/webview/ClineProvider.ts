	...
	implements vscode.WebviewViewProvider, TelemetryPropertiesProvider, TaskProviderLike
{
	...
	private creditsStatusBar?: any // for credits status bar management
	private autoPurgeScheduler?: any // kilocode_change - (Any) Prevent circular import

	private recentTasksCache?: string[]
	private balanceHandlers: Array<(data: BalanceDataResponsePayload) => void> = [] // for credits balance updates
