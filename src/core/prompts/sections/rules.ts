...
function getEditingInstructions(
	...
	if (hasInsertContent) {
		availableTools.push("`insert_content` (for inserting lines to files at specific line numbers)")
	}
