	...
	return (
		<div
			...
			className={
				isHidden
					? "hidden"
					: "fixed top-0 left-0 right-0 bottom-0 max-w-3xl mx-auto flex flex-col overflow-hidden"
			}>
				...
				<div className="flex-1 min-h-0 overflow-y-auto flex flex-col gap-4 relative">
					...
					<div className="w-full h-full flex flex-col gap-4 px-3.5 transition-all duration-300">
						...
						<div className="flex flex-grow flex-col justify-center gap-4">
							{/* kilocode_change end */}
							<p className="hidden text-vscode-editor-foreground leading-normal font-vscode-font-family text-center text-balance max-w-[380px] mx-auto my-0">
								<Trans
									i18nKey="chat:about"
									components={{
										DocsLink: (
